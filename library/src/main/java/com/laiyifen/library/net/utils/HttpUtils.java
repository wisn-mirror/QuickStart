package com.laiyifen.library.net.utils;
...
//                String headerValue = URLEncoder.encode(entry.getValue(), "UTF-8");
    ...
    public static boolean deleteFile(String path) {
        ...
        if (file.isFile()) {
            ...
            NetLog.e("deleteFile:" + delete + " path:" + path);
            return delete;
        }
        return false;
    }
    ...
    public static  boolean isNetConnected() {
        ConnectivityManager cm = (ConnectivityManager) Net.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm != null) {
