package com.laiyifen.library.view.refresh;
...
import com.laiyifen.library.view.refresh.api.DefaultRefreshFooterCreator;
import com.laiyifen.library.view.refresh.api.DefaultRefreshHeaderCreator;
import com.laiyifen.library.view.refresh.api.RefreshContent;
...
import com.laiyifen.library.view.refresh.constant.DimensionStatus;
...
import com.laiyifen.library.view.refresh.footer.BallPulseFooter;
import com.laiyifen.library.view.refresh.header.BezierRadarHeader;
import com.laiyifen.library.view.refresh.impl.RefreshContentWrapper;
import com.laiyifen.library.view.refresh.impl.RefreshFooterWrapper;
import com.laiyifen.library.view.refresh.impl.RefreshHeaderWrapper;
import com.laiyifen.library.view.refresh.listener.OnLoadMoreListener;
import com.laiyifen.library.view.refresh.listener.OnMultiPurposeListener;
import com.laiyifen.library.view.refresh.listener.OnRefreshListener;
import com.laiyifen.library.view.refresh.listener.OnRefreshLoadMoreListener;
import com.laiyifen.library.view.refresh.listener.OnStateChangedListener;
import com.laiyifen.library.view.refresh.utils.DelayedRunnable;
...
import com.laiyifen.library.view.refresh.utils.ViscousFluidInterpolator;
...
import static com.laiyifen.library.view.refresh.utils.DensityUtil.dp2px;
import static com.laiyifen.library.view.refresh.utils.SmartUtil.fling;
import static com.laiyifen.library.view.refresh.utils.SmartUtil.getColor;
import static com.laiyifen.library.view.refresh.utils.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     * 设置多功能监听器
     *
     * @param listener 建议使用 { SimpleMultiPurposeListener}
     *
     * @return SmartRefreshLayout
     */
    @Override
     ...
     * 设置滚动边界
     *
     * @param boundary 建议使用 {ScrollBoundaryDeciderAdapter}
     *
     * @return SmartRefreshLayout
     */
    @Override
