...
backup_Dir=/Users/mac/Desktop/Version/testbackup
...
echo 开始打包
sh ./gradlew clean assembleRelease | grep -v 'testReleasebuildlog.txt' > ${BuildLog}/testReleasebuildlog.txt
...
done <${BuildLog}/testReleasebuildlog.txt
